...
func AllBindings() []KeyBinding {
	return []KeyBinding{
		...
		{Category: "Navigation", Key: "Cmd+Shift+←", Description: "Move tab left"},
		{Category: "Navigation", Key: "Cmd+Shift+→", Description: "Move tab right"},
		...
		{Category: "Copy / Paste", Key: "Click+drag", Description: "Select text"},
